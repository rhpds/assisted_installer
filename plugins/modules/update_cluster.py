...
short_description: Updates an OpenShift cluster definition.
...
EXAMPLES = r'''
- name: Updates an OpenShift cluster definition
  register: r_update_cluster
  rhpds.assisted_installer.update_cluster:
    cluster_id: "{{ newcluster.result.id }}"
    offline_token: "{{ offline_token }}"
    cluster_update_params: '{"base_dns_domain":"example.com"}'
'''
