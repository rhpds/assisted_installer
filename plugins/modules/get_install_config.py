...
DOCUMENTATION = r'''
---
module: get_install_config

short_description: Get the cluster's install config YAML.
...
EXAMPLES = r'''
- name: Obtain OpenShift cluster install config
  register: r_install_config
  rhpds.assisted_installer.get_install_config:
