...
DOCUMENTATION = r'''
---
module: get_pull_secret

short_description: Get access token from registries in docker format

version_added: "1.0.0"

description: Get access token from registries in docker format
